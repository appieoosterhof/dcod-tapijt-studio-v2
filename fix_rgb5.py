...
for i, (label, hex_val, rgb) in enumerate(zip(kleuren_labels, defaults_hex, defaults_rgb)):
    r, g, b = rgb
    nieuw_palet += f'''        <div style="margin-bottom:12px;padding:10px;border:1px solid #eee;border-radius:8px;background:#fafafa;box-sizing:border-box;">
          <label style="font-size:12px;color:#666;font-weight:bold;display:block;margin-bottom:8px;">{label}</label>
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:nowrap;">
            <input type="color" id="kleur{i}" value="{hex_val}" style="width:44px;height:38px;border:1px solid #ddd;border-radius:6px;cursor:pointer;padding:2px;flex-shrink:0;">
            <div style="flex:1.8;min-width:0;">
              <div style="font-size:10px;color:#999;margin-bottom:3px;">HEX</div>
              <input type="text" id="kleur{i}hex" value="{hex_val}" maxlength="7" style="width:100%;padding:6px;border:1px solid #ddd;border-radius:4px;font-size:12px;font-family:monospace;text-align:center;box-sizing:border-box;">
            </div>
            <div style="flex:1;min-width:0;">
              <div style="font-size:10px;color:#999;margin-bottom:3px;">R</div>
            ...
            <div style="flex:1;min-width:0;">
              <div style="font-size:10px;color:#999;margin-bottom:3px;">G</div>
            ...
            <div style="flex:1;min-width:0;">
              <div style="font-size:10px;color:#999;margin-bottom:3px;">B</div>
